...
#ifdef ADB
	char 		regist_conninfo[MAXLEN];
	char    group_name[MAXLEN];
	int 		is_agtm;
#endif	
 ...
 */
#ifdef ADB
#define T_CONFIGURATION_OPTIONS_INITIALIZER { "", UNKNOWN_NODE_ID, NO_UPSTREAM_NODE, "", "", "", IS_NOT_AGTM_SERVER, "", "", MANUAL_FAILOVER, -1, "", "", "", "", "", "", "", "", "", "", "", "", -1, -1, -1, "", "", "", "", "", 0, 0, 0, 0, "", { NULL, NULL }, { NULL, NULL } }
#else 
